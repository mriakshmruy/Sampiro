  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= SampiroBreakpoints.small) {
          return small(context, child);
        } else if (constraints.maxWidth <= SampiroBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        } else if (constraints.maxWidth <= SampiroBreakpoints.large) {
